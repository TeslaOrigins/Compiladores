...
public final class ASeSemCasamentoSeSemCasamento extends PSeSemCasamento
{
    private TSe _se_;
    ...
    public ASeSemCasamentoSeSemCasamento()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASeSemCasamentoSeSemCasamento(
            cloneNode(this._se_),
    ...
    {
        ((Analysis) sw).caseASeSemCasamentoSeSemCasamento(this);
    }
