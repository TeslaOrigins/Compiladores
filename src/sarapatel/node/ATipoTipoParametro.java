...
public final class ATipoTipoParametro extends PTipoParametro
{
    private TTipoBase _tipoBase_;

    public ATipoTipoParametro()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseATipoTipoParametro(this);
    }
