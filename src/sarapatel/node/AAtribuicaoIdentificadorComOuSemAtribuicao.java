...
public final class AAtribuicaoIdentificadorComOuSemAtribuicao extends PIdentificadorComOuSemAtribuicao
{
    private PIdAtribuicao _idAtribuicao_;

    public AAtribuicaoIdentificadorComOuSemAtribuicao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAtribuicaoIdentificadorComOuSemAtribuicao(
    ...
    {
        ((Analysis) sw).caseAAtribuicaoIdentificadorComOuSemAtribuicao(this);
    }
