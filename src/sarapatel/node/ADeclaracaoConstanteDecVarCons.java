...
public final class ADeclaracaoConstanteDecVarCons extends PDecVarCons
{
    private PDecCons _decCons_;

    public ADeclaracaoConstanteDecVarCons()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADeclaracaoConstanteDecVarCons(
    ...
    {
        ((Analysis) sw).caseADeclaracaoConstanteDecVarCons(this);
    }
