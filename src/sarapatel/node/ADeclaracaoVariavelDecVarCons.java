...
public final class ADeclaracaoVariavelDecVarCons extends PDecVarCons
{
    private PDecVar _decVar_;

    public ADeclaracaoVariavelDecVarCons()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADeclaracaoVariavelDecVarCons(
    ...
    {
        ((Analysis) sw).caseADeclaracaoVariavelDecVarCons(this);
    }
