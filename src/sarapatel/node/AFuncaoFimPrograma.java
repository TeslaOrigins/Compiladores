...
public final class AFuncaoFimPrograma extends PFimPrograma
{
    private PDecFuncao _decFuncao_;

    public AFuncaoFimPrograma()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAFuncaoFimPrograma(this);
    }
