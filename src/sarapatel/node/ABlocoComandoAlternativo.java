...
public final class ABlocoComandoAlternativo extends PComandoAlternativo
{
    private PBlocoComandos _blocoComandos_;

    public ABlocoComandoAlternativo()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABlocoComandoAlternativo(
    ...
    {
        ((Analysis) sw).caseABlocoComandoAlternativo(this);
    }
