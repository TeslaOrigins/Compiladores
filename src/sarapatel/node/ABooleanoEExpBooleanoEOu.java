...
public final class ABooleanoEExpBooleanoEOu extends PExpBooleanoEOu
{
    private PExpBooleanoEOu _expBooleanoEOu_;
    private TE _e_;
    private PExpNegacao _expNegacao_;

    public ABooleanoEExpBooleanoEOu()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABooleanoEExpBooleanoEOu(
    ...
    {
        ((Analysis) sw).caseABooleanoEExpBooleanoEOu(this);
    }
