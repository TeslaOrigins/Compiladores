...
public final class AProcedimentoFimPrograma extends PFimPrograma
{
    private PDecProcedimento _decProcedimento_;

    public AProcedimentoFimPrograma()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AProcedimentoFimPrograma(
    ...
    {
        ((Analysis) sw).caseAProcedimentoFimPrograma(this);
    }
